...
import styles from './styles/styles.activebottommenu';
import Swipeable from 'react-native-gesture-handler/Swipeable';
import Loader from '../../Loading/loader'
import { RectButton } from "react-native-gesture-handler";

class ActiveBottomMenu extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  this.props.pickup(this.props.id)
  }
...
onSwipeableLeftWillOpen={this.onSwipeableLeftWillOpen}
        ...
        <View style={styles.swipeView}>
              ...
              />
              <Text style={styles.swipeText}>Swipe to confirm Pick Up</Text>
            </View>     
            </Swipeable>
          </View>
        </TouchableOpacity>
...
export default ActiveBottomMenu;
